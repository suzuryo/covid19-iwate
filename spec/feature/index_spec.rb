...
describe "iPhone 6/7/8", type: :feature do
  context 'page [/]' do
    ...
    it 'h1/h2' do
      expect(find('#app > div > div.appContainer > div > div > header > h1').text).to eq "新型コロナウイルス感染症\n対策サイト（非公式）"
      expect(find('#app > div > div.appContainer > main > div > div > div.MainPage > div.Header.mb-3 > div.header > h2').text).to eq '岩手の最新感染動向'
    end
