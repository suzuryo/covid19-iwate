  ...
  context 'page [/]' do
    ...
    describe '検査実施件数(TestedNumberCard)' do
      it '項目の値' do
        ...
        expect(find('#TestedNumberCard > div > div > div.DataView-ExpantionPanel > div > div > div > div > div > div > table > tbody > tr:nth-child(1) > td:nth-child(2)').text).to eq "#{d}"
        ...
        expect(find('#TestedNumberCard > div > div > div.DataView-ExpantionPanel > div > div > div > div > div > div > table > tbody > tr:nth-child(1) > td:nth-child(3)').text).to eq "#{d}"
        ...
        expect(find('#TestedNumberCard > div > div > div.DataView-ExpantionPanel > div > div > div > div > div > div > table > tbody > tr:nth-child(1) > td:nth-child(4)').text).to eq "#{d}"
        ...
        expect(find('#TestedNumberCard > div > div > div.DataView-ExpantionPanel > div > div > div > div > div > div > table > tbody > tr:nth-child(1) > td:nth-child(5)').text).to eq "#{d}"
      end
    end
