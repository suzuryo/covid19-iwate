...
## コミュニケーションへの参加方法
* Slackチャンネルがあります https://iwatedevelopersmeetup.slack.com/
* `#covid19-iwate` チャンネルにご参加ください。
...
## 開発に関する情報
* ステージングサイト https://staging-covid19-iwate.netlify.com/
* 本番サイト https://iwate.stopcovid19.jp/
