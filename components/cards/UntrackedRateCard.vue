        ...
        <template v-slot:additionalDescription>
          ...
          <ul>
            ...
            <li>
              {{
                $t(
                  '集団感染発生や曜日による数値のばらつきにより、日々の結果が変動するため、こうしたばらつきを平準化し全体の傾向を見る趣旨から、過去7日間の移動平均値を不明者数として算出（例えば、8月7日の移動平均値は、8月1日から8月7日までの実績値を平均したもの）'
                )
              }}
            </li>
            <!--
            ...
            <li>
              {{
                $t('増加比は、1週間前の接触歴等不明者数（移動平均値）との比較')
              }}
            </li>
          </ul>
        </template>
